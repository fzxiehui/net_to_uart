...
func NewMqtt(broker string,
	...
	opts.SetDefaultPublishHandler(SubscribeHandler)
	mq = &MQTT{
		Opts:        opts,
		RecvHandler: nil,
	}
...
func SubscribeHandler(client EMQTT.Client, msg EMQTT.Message) {

	if mq.RecvHandler != nil {
		mq.RecvHandler(msg.Topic(), msg.Payload())
	}
